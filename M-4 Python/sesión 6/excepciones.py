...
'''
Las excepciones pueden ocurrir al momento de transformación, lectura de archivos, asignación de algún elemento, buscar indice no existente, evaluando una variable, comunicación con un ente externo, en la interpretación del código.
