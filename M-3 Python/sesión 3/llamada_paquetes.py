#import nombre_carpeta.nombre archivo as alias
...
#se necesita definir el alias funciones para que no de error de no definido
funciones.resta(2,3) #NameError: name 'funciones¿ is not defined