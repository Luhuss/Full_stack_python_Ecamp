...
from . import views
# importar views
from .views import IndexPageView, lista_libros, crear_libro, editar_libro, eliminar_libro, registro, iniciar_sesion, home_page, cerrar_sesion, buscar
...
urlpatterns = [
    ...
    # path('logout/', views.cerrar_sesion, name='logout'), # esta es un importación estatica
    path('logout/', cerrar_sesion, name='logout'), # registra ruta para cerrar sesion
