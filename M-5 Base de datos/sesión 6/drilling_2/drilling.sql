...
-- 1.- Listar todos loas arriendos con las siguientes columnas folio, fecha, dia, valorDia, nombreCliente, rutCliente
-- tabla arriendo a = a.folio, a.dias, a.valor_dia
...
-- 2.- Listar los clientes son arriendo
...
-- 3.- Lista rut y nombre de los clientes y empresas
SELECT rut, nombre FROM cliente
UNION
SELECT rut, nombre FROM empresa;

SELECT c.rut AS rut_cliente, c.nombre AS nombre_cliente, e.rut AS 
rut_empresa, e.nombre AS nombre_empresa
FROM cliente c 
CROSS JOIN empresa e;

-- 4.- Listar la cantidad de arriendo por mes
SELECT 
